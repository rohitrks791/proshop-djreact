...
inoremap <silent> <SNR>129_AutoPairsReturn =AutoPairsReturn()
...
map he :call VimuxRunCommand("clear; python " . bufname("%"))
nmap hca <Plug>NERDCommenterAltDelims
xmap hcu <Plug>NERDCommenterUncomment
nmap hcu <Plug>NERDCommenterUncomment
xmap hcb <Plug>NERDCommenterAlignBoth
nmap hcb <Plug>NERDCommenterAlignBoth
xmap hcl <Plug>NERDCommenterAlignLeft
nmap hcl <Plug>NERDCommenterAlignLeft
nmap hcA <Plug>NERDCommenterAppend
xmap hcy <Plug>NERDCommenterYank
nmap hcy <Plug>NERDCommenterYank
xmap hcs <Plug>NERDCommenterSexy
nmap hcs <Plug>NERDCommenterSexy
xmap hci <Plug>NERDCommenterInvert
nmap hci <Plug>NERDCommenterInvert
nmap hc$ <Plug>NERDCommenterToEOL
xmap hcn <Plug>NERDCommenterNested
nmap hcn <Plug>NERDCommenterNested
xmap hcm <Plug>NERDCommenterMinimal
nmap hcm <Plug>NERDCommenterMinimal
xmap hc  <Plug>NERDCommenterToggle
nmap hc  <Plug>NERDCommenterToggle
xmap hcc <Plug>NERDCommenterComment
nmap hcc <Plug>NERDCommenterComment
nmap hwhm <Plug>VimwikiMakeTomorrowDiaryNote
nmap hwhy <Plug>VimwikiMakeYesterdayDiaryNote
nmap hwht <Plug>VimwikiTabMakeDiaryNote
nmap hwhw <Plug>VimwikiMakeDiaryNote
nmap hwhi <Plug>VimwikiDiaryGenerateLinks
nmap hwi <Plug>VimwikiDiaryIndex
nmap hws <Plug>VimwikiUISelect
nmap hwt <Plug>VimwikiTabIndex
nmap hww <Plug>VimwikiIndex
nnoremap <silent> hM :call magit#show_magit('v')
map hq :VimuxCloseRunner
map hl :VimuxRunLastCommand
map hp :VimuxPromptCommand
nnoremap map <silent> vv v
nmap ySS <Plug>YSsurround
nmap ySs <Plug>YSsurround
nmap yss <Plug>Yssurround
nmap yS <Plug>YSurround
nmap ys <Plug>Ysurround
nnoremap <SNR>245_: :=v:count ? v:count : ''
nmap <C-L> l
nmap <C-H> h
xmap <C-H> h
nmap <C-J> j
xmap <C-J> j
nnoremap <SNR>239_: :=v:count ? v:count : ''
nnoremap <SNR>243_: :=v:count ? v:count : ''
...
set runtimepath+=~/.vim/plugged/vimagit
set runtimepath+=~/.vim/plugged/vimling
...
set runtimepath+=~/.vim/plugged/AutoComplPop
set runtimepath+=~/.vim/plugged/vimux
set runtimepath+=~/.vim/plugged/ultisnips
set runtimepath+=~/.vim/plugged/tagalong.vim
set runtimepath+=~/.vim/plugged/Rainbow-Parenthesis
...
set runtimepath+=~/.vim/plugged/vim-es2015-snippets
...
tabnew
tabrewind
edit base/serializers.py
argglobal
balt base/serializers.py
let s:cpo_save=&cpo
set cpo&vim
...
nmap <buffer> hhp <Plug>(GitGutterPreviewHunk)
nmap <buffer> hhu <Plug>(GitGutterUndoHunk)
nmap <buffer> hhs <Plug>(GitGutterStageHunk)
xmap <buffer> hhs <Plug>(GitGutterStageHunk)
map <buffer> hD ?def 
map <buffer> hC ?class 
map <buffer> h2 /def 
map <buffer> h1 /class 
...
silent! normal! zE
let &fdl = &fdl
let s:l = 22 - ((16 * winheight(0) + 14) / 29)
...
normal! 0
tabnext
edit base/urls/user_urls.py
argglobal
balt base/urls/user_urls.py
let s:cpo_save=&cpo
set cpo&vim
inoremap <buffer> <silent> <M-n> :call AutoPairsJump()a
inoremap <buffer> <silent> <expr> <M-p> AutoPairsToggle()
...
normal! 05|
tabnext
edit base/views/user_views.py
argglobal
balt base/views/user_views.py
let s:cpo_save=&cpo
set cpo&vim
inoremap <buffer> <silent> <M-n> :call AutoPairsJump()a
inoremap <buffer> <silent> <expr> <M-p> AutoPairsToggle()
...
silent! normal! zE
let &fdl = &fdl
let s:l = 98 - ((7 * winheight(0) + 14) / 29)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 98
...
exe 'vert 2resize ' . ((&columns * 35 + 83) / 167)
tabnext
edit base/urls/product_urls.py
argglobal
balt base/urls/product_urls.py
let s:cpo_save=&cpo
set cpo&vim
inoremap <buffer> <silent> <M-n> :call AutoPairsJump()a
inoremap <buffer> <silent> <expr> <M-p> AutoPairsToggle()
...
normal! 0
tabnext
edit base/views/product_views.py
argglobal
balt base/views/product_views.py
let s:cpo_save=&cpo
set cpo&vim
inoremap <buffer> <silent> <M-n> :call AutoPairsJump()a
inoremap <buffer> <silent> <expr> <M-p> AutoPairsToggle()
...
silent! normal! zE
let &fdl = &fdl
let s:l = 89 - ((7 * winheight(0) + 14) / 29)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 89
...
normal! 060|
tabnext 7
badd +21 base/serializers.py
badd +1 base/urls/user_urls.py
badd +1 base/views/user_views.py
badd +13 base/urls/order_urls.py
badd +1 base/models.py
badd +95 base/views/order_views.py
badd +0 backend/__init__.py
badd +0 base/views/product_views.py
badd +0 base/urls/product_urls.py
